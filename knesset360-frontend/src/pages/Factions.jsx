...
//                 <h3>{stats.faction.name} — נתוני חקיקה</h3>
//                 {stats.faction.startdate && (
//                   <p className="faction-dates">
//                     {new Date(stats.faction.startdate).getFullYear()}
//                     {stats.faction.finishdate
//                       ? ` – ${new Date(stats.faction.finishdate).getFullYear()}`
//                       : ' – היום'}
//                   </p>
//                 )}
//               </div>
//               {FACTION_LOGOS[stats.faction.name] && (
//                 <img
//                   src={FACTION_LOGOS[stats.faction.name]}
//                   alt={stats.faction.name}
    ...
    <div className="factions-page" dir="rtl">
      ...
      {stats && !loading && (
        <div className="stats-panel">
          ...
          {topMKs.length > 0 && (
            <div className="top-mks-section">
              <h4 className="topics-title">
                {selectedTopic ? `חברי כנסת מובילים — ${selectedTopic}` : 'חברי כנסת מובילים'}
              </h4>
